...
def main():
   ...
   " be "," but ","But "," by ","By "," can "," could ","Could "," did ","Did "," do ","Do "," does ","Does "," for "," from "," had ",
   " has "," have "," how ","How "," I ","I "," if ","If "," in ","In "," is ","Is "," it ","It "," its "," if ","If "," my ","My "," no "," not ",
   " on ","On "," or ","Or "," of "," our ","Our "," should ","Should "," so ","So "," that ","That "," than ","Than "," the ","The ",
   " them ","Them "," then ","Then", " these ","These "," there "," they ","They "," this ","This "," their "," those ","Those "," to ",
   " too "," us ","You "," you ","Your "," your "," was ","Was "," were ","Were "," what ","What "," we ","We "," were ","Were ",
   " when ","When "," where ","Where "," which ","Which "," why ","Why "," who ","Who "," will "," with ","With "," would "," yet "]
   #
